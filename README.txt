...
a persistence unit "eva62cabreraPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62cabrera/pom.xml":
...
artifact ("eva62cabrera.war") is already built. You can build
